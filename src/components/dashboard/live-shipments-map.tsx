    ...
    <div className="overflow-hidden rounded-xl border border-border bg-card shadow-sm">
      <div className="flex flex-wrap items-center justify-between gap-3 border-b border-border px-4 py-3">
        <div className="flex items-center gap-2">
          ...
          <h3 className="font-heading text-sm font-semibold">Live shipment map</h3>
      ...
      <div className="relative bg-[color-mix(in_oklch,var(--muted),var(--background)_40%)]">
        ...
        {selected && (
          <div className="absolute bottom-3 left-3 w-64 rounded-lg border border-border bg-card p-3 text-sm shadow-lg">
            <div className="flex items-start justify-between gap-2">
              <p className="font-mono text-xs font-semibold">{selected.trackingNumber}</p>
              <button
